...
export const getDynamicUserRoutes = async () => {
    const response = await ofetch('https://hasebetest-front-nuxt-auth20220913-2.g.kuroco.app/rcms-api/1/member/list');
...
export const getDynamicContentRoutes = async () => {
    const response = await ofetch('https://hasebetest-front-nuxt-auth20220913-2.g.kuroco.app/rcms-api/1/content/list');
